...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { cedula: @administrador.cedula, nombre: @administrador.nombre, puntos_id: @administrador.puntos_id } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { cedula: @administrador.cedula, nombre: @administrador.nombre, puntos_id: @administrador.puntos_id } }
