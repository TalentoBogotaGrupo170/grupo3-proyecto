...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { cedula: @estudiante.cedula, edad: @estudiante.edad, nombre: @estudiante.nombre, poblacion_id: @estudiante.poblacion_id, puntos_id: @estudiante.puntos_id } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { cedula: @estudiante.cedula, edad: @estudiante.edad, nombre: @estudiante.nombre, poblacion_id: @estudiante.poblacion_id, puntos_id: @estudiante.puntos_id } }
